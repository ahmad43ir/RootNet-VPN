...
// Release signing — shares the RootNet keystore. Credentials live in
// keystore.properties (gitignored) at the proxybox-app root; storeFile points
// at the shared android-app/keystore/rootnet-release.jks. Missing file =
...
android {
    namespace = "com.chobgroup.proxybox"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.chobgroup.proxybox"
        minSdk = 23
        targetSdk = 36
        versionCode = 1
        versionName = "0.1.0"
