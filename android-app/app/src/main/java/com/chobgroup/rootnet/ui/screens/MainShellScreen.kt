...
/**
 * Main shell — v2.0 config launcher. Two tabs: Servers (the config list with
 * copy/export actions + banner ad) and Settings (about + client help).
 */
@Composable
fun MainShellScreen() {
    ...
    Scaffold(
        ...
        bottomBar = {
            BottomBar(
                items = listOf(
                    BottomBarItem(0, "Servers", Icons.Outlined.List, Icons.Filled.List),
                    BottomBarItem(1, "Settings", Icons.Outlined.Settings, Icons.Filled.Settings),
                ),
