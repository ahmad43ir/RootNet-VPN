...
class ServerCacheStore private constructor() {
    ...
    // ── File tab (vpn_files) cache + unlock flag ─────────────────────────
    ...
    /**
     * Where a downloaded file was saved — a `content://` URI (API 29+
     ...
     * plays a single time per file — retries after a failed download (and any
